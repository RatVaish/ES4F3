...
HD_PWD='C:/Users/ratul/ES4F3/ES4F3/Zybo-Z7-20-pcam-filter/pcam_filter.runs/system_overlay_core_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_overlay_core_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_overlay_core_0_2.tcl
