...
HD_PWD='C:/Users/ratul/ES4F3/ES4F3/Zybo-Z7-20-pcam-filter/pcam_filter.runs/system_multipix_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_multipix_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_multipix_ctrl_0_0.tcl
