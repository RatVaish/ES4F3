...
/* Definitions for driver OVERLAY_CORE */
#define XPAR_XOVERLAY_CORE_NUM_INSTANCES 1

/* Definitions for peripheral OVERLAY_CORE_0 */
#define XPAR_OVERLAY_CORE_0_DEVICE_ID 0
#define XPAR_OVERLAY_CORE_0_S_AXI_CTRL_BASEADDR 0x40000000
#define XPAR_OVERLAY_CORE_0_S_AXI_CTRL_HIGHADDR 0x4000FFFF


/******************************************************************/

/* Canonical definitions for peripheral OVERLAY_CORE_0 */
#define XPAR_XOVERLAY_CORE_0_DEVICE_ID XPAR_OVERLAY_CORE_0_DEVICE_ID
#define XPAR_XOVERLAY_CORE_0_S_AXI_CTRL_BASEADDR 0x40000000
#define XPAR_XOVERLAY_CORE_0_S_AXI_CTRL_HIGHADDR 0x4000FFFF
