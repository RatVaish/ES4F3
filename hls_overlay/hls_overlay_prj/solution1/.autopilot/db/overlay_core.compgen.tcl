...
set name overlay_core_mul_16ns_16ns_32_2_1
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 40 \
			corename overlay_core_CTRL_axilite \
			name overlay_core_CTRL_s_axi \
			ports {$port_CTRL} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler overlay_core_CTRL_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_out_TVALID { O 1 bit } stream_out_TREADY { I 1 bit } stream_out_TDEST { O 1 vector } } \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler overlay_core_regslice_both BINDTYPE {interface} TYPE {adapter} IMPL {reg_slice}
}
