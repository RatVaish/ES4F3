...
#define CTRL_ADDR_X_POS_DATA  0x10
#define CTRL_BITS_X_POS_DATA  16
#define CTRL_ADDR_Y_POS_DATA  0x18
#define CTRL_BITS_Y_POS_DATA  16
#define CTRL_ADDR_HEIGHT_DATA 0x20
#define CTRL_BITS_HEIGHT_DATA 16
#define CTRL_ADDR_WIDTH_DATA  0x28
