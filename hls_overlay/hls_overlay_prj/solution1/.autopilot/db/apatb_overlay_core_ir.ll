; ModuleID = 'C:/Users/ratul/ES4F3/ES4F3/hls_overlay/hls_overlay_prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_overlay_core_ir(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* noalias nonnull dereferenceable(12) %stream_in, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* noalias nonnull dereferenceable(12) %stream_out, %"struct.ap_uint<1>"* nocapture readonly %enable, %"struct.ap_uint<16>"* nocapture readonly %x_pos, %"struct.ap_uint<16>"* nocapture readonly %y_pos, %"struct.ap_uint<16>"* nocapture readonly %height, %"struct.ap_uint<16>"* nocapture readonly %width) local_unnamed_addr #0 {
entry:
  %stream_in_copy.data = alloca i24, align 512
  %stream_in_copy.keep = alloca i3, align 512
  %stream_in_copy.strb = alloca i3, align 512
  %stream_in_copy.user = alloca i1, align 512
  %stream_in_copy.last = alloca i1, align 512
  %stream_in_copy.id = alloca i1, align 512
  %stream_in_copy.dest = alloca i1, align 512
  %stream_out_copy.data = alloca i24, align 512
  %stream_out_copy.keep = alloca i3, align 512
  %stream_out_copy.strb = alloca i3, align 512
  %stream_out_copy.user = alloca i1, align 512
  %stream_out_copy.last = alloca i1, align 512
  %stream_out_copy.id = alloca i1, align 512
  %stream_out_copy.dest = alloca i1, align 512
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* nonnull %stream_in, i24* nonnull align 512 %stream_in_copy.data, i3* nonnull align 512 %stream_in_copy.keep, i3* nonnull align 512 %stream_in_copy.strb, i1* nonnull align 512 %stream_in_copy.user, i1* nonnull align 512 %stream_in_copy.last, i1* nonnull align 512 %stream_in_copy.id, i1* nonnull align 512 %stream_in_copy.dest, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* nonnull %stream_out, i24* nonnull align 512 %stream_out_copy.data, i3* nonnull align 512 %stream_out_copy.keep, i3* nonnull align 512 %stream_out_copy.strb, i1* nonnull align 512 %stream_out_copy.user, i1* nonnull align 512 %stream_out_copy.last, i1* nonnull align 512 %stream_out_copy.id, i1* nonnull align 512 %stream_out_copy.dest)
  call void @apatb_overlay_core_hw(i24* %stream_in_copy.data, i3* %stream_in_copy.keep, i3* %stream_in_copy.strb, i1* %stream_in_copy.user, i1* %stream_in_copy.last, i1* %stream_in_copy.id, i1* %stream_in_copy.dest, i24* %stream_out_copy.data, i3* %stream_out_copy.keep, i3* %stream_out_copy.strb, i1* %stream_out_copy.user, i1* %stream_out_copy.last, i1* %stream_out_copy.id, i1* %stream_out_copy.dest, %"struct.ap_uint<1>"* %enable, %"struct.ap_uint<16>"* %x_pos, %"struct.ap_uint<16>"* %y_pos, %"struct.ap_uint<16>"* %height, %"struct.ap_uint<16>"* %width)
  call void @copy_back(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %stream_in, i24* %stream_in_copy.data, i3* %stream_in_copy.keep, i3* %stream_in_copy.strb, i1* %stream_in_copy.user, i1* %stream_in_copy.last, i1* %stream_in_copy.id, i1* %stream_in_copy.dest, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %stream_out, i24* %stream_out_copy.data, i3* %stream_out_copy.keep, i3* %stream_out_copy.strb, i1* %stream_out_copy.user, i1* %stream_out_copy.last, i1* %stream_out_copy.id, i1* %stream_out_copy.dest)
  ret void
}
...
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>.18"(i24* align 512 %_V_data_V, i3* align 512 %_V_keep_V, i3* align 512 %_V_strb_V, i1* align 512 %_V_user_V, i1* align 512 %_V_last_V, i1* align 512 %_V_id_V, i1* align 512 %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>.18"(i24* align 512 %_V_data_V1, i3* align 512 %_V_keep_V2, i3* align 512 %_V_strb_V3, i1* align 512 %_V_user_V4, i1* align 512 %_V_last_V5, i1* align 512 %_V_id_V6, i1* align 512 %_V_dest_V7, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %1)
  ret void
}
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>.13"(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* nonnull %dst, i24* align 512 %src_V_data_V, i3* align 512 %src_V_keep_V, i3* align 512 %src_V_strb_V, i1* align 512 %src_V_user_V, i1* align 512 %src_V_last_V, i1* align 512 %src_V_id_V, i1* align 512 %src_V_dest_V)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>.13"(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* noalias nocapture, i24* noalias nocapture align 512 "unpacked"="1.0" %_V_data_V, i3* noalias nocapture align 512 "unpacked"="1.1" %_V_keep_V, i3* noalias nocapture align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias nocapture align 512 "unpacked"="1.3" %_V_user_V, i1* noalias nocapture align 512 "unpacked"="1.4" %_V_last_V, i1* noalias nocapture align 512 "unpacked"="1.5" %_V_id_V, i1* noalias nocapture align 512 "unpacked"="1.6" %_V_dest_V) unnamed_addr #4 {
entry:
  %1 = alloca i24
  %2 = alloca i3
  %3 = alloca i3
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>.18"(i24* noalias align 512 "unpacked"="0.0" %dst_V_data_V, i3* noalias align 512 "unpacked"="0.1" %dst_V_keep_V, i3* noalias align 512 "unpacked"="0.2" %dst_V_strb_V, i1* noalias align 512 "unpacked"="0.3" %dst_V_user_V, i1* noalias align 512 "unpacked"="0.4" %dst_V_last_V, i1* noalias align 512 "unpacked"="0.5" %dst_V_id_V, i1* noalias align 512 "unpacked"="0.6" %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* noalias %src) unnamed_addr #3 {
entry:
  %0 = icmp eq %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>.21"(i24* align 512 %dst_V_data_V, i3* align 512 %dst_V_keep_V, i3* align 512 %dst_V_strb_V, i1* align 512 %dst_V_user_V, i1* align 512 %dst_V_last_V, i1* align 512 %dst_V_id_V, i1* align 512 %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>.21"(i24* noalias nocapture align 512 "unpacked"="0.0" %_V_data_V, i3* noalias nocapture align 512 "unpacked"="0.1" %_V_keep_V, i3* noalias nocapture align 512 "unpacked"="0.2" %_V_strb_V, i1* noalias nocapture align 512 "unpacked"="0.3" %_V_user_V, i1* noalias nocapture align 512 "unpacked"="0.4" %_V_last_V, i1* noalias nocapture align 512 "unpacked"="0.5" %_V_id_V, i1* noalias nocapture align 512 "unpacked"="0.6" %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* noalias nocapture) unnamed_addr #4 {
entry:
...
declare void @apatb_overlay_core_hw(i24*, i3*, i3*, i1*, i1*, i1*, i1*, i24*, i3*, i3*, i1*, i1*, i1*, i1*, %"struct.ap_uint<1>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*)
...
define void @overlay_core_hw_stub_wrapper(i24*, i3*, i3*, i1*, i1*, i1*, i1*, i24*, i3*, i3*, i1*, i1*, i1*, i1*, %"struct.ap_uint<1>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*) #5 {
entry:
  ...
  call void @overlay_core_hw_stub(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %19, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %20, %"struct.ap_uint<1>"* %14, %"struct.ap_uint<16>"* %15, %"struct.ap_uint<16>"* %16, %"struct.ap_uint<16>"* %17, %"struct.ap_uint<16>"* %18)
...
declare void @overlay_core_hw_stub(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* noalias nonnull, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* noalias nonnull, %"struct.ap_uint<1>"* nocapture readonly, %"struct.ap_uint<16>"* nocapture readonly, %"struct.ap_uint<16>"* nocapture readonly, %"struct.ap_uint<16>"* nocapture readonly, %"struct.ap_uint<16>"* nocapture readonly)
