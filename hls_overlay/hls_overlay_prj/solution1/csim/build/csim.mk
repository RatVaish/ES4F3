...
HLS_SOURCES = ../../../../overlay_core_test.cpp ../../../../overlay_core.cpp
...
$(ObjDir)/overlay_core_test.o: ../../../../overlay_core_test.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../overlay_core_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/overlay_core_test.d

$(ObjDir)/overlay_core.o: ../../../../overlay_core.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../overlay_core.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/overlay_core.d
