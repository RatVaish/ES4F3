...
#define XOVERLAY_CORE_CTRL_ADDR_AP_CTRL     0x00
#define XOVERLAY_CORE_CTRL_ADDR_GIE         0x04
#define XOVERLAY_CORE_CTRL_ADDR_IER         0x08
#define XOVERLAY_CORE_CTRL_ADDR_ISR         0x0c
